...
| **[VIRTUAL_CHANNEL_ROUTING_ADR.md](./VIRTUAL_CHANNEL_ROUTING_ADR.md)** | Normative virtual buckets (`announcements` / `inbox` / `polls` / `join_requests`): rumor tag + JSON field + derivation (single-group refactor) |
