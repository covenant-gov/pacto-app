...
/// Account `verificationGasLimit` (SemiModularAccount7702 validateUserOp).
pub const DEFAULT_VERIFICATION_GAS_LIMIT: u128 = 100_000;
/// Paymaster `paymasterVerificationGasLimit` / header uint128 (registry + Hats eligibility).
/// Tuned for Alchemy: above ~113k used (avoids OOG) and ≤ used/0.4 efficiency floor (~283k).
pub const DEFAULT_PAYMASTER_VERIFICATION_GAS_LIMIT: u128 = 250_000;
...
mod tests {
    ...
    fn encode_paymaster_and_data_matches_golden_vector() {
        ...
        let expected = "";
