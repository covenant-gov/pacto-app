...
describe('pacto-protocol-addresses', () => {
  it('loads Sepolia sponsor and gov factories from the book', () => {
    ...
    expect(sepolia?.squadSponsor?.factory).toBe('0x032e84cff3b32c221f8F93e4839Fa5715638ae08');
    expect(sepolia?.squadSponsor?.paymaster).toBe('0xF7f557a9443671EB0f5a3F1b233Ac44A9eDa24B8');
