 ...
 * chatId is the other party's npub. Prefer startDeleteDmChat() for optimistic Friends removal.
 */
...
export type MlsVirtualBucket = 'announcements' | 'inbox' | 'polls' | 'join_requests';
